...
void nn_32( Uint8 *src_surface, SDL_Surface *dst_surface, int scale );
void nn_16( Uint8 *src_surface, SDL_Surface *dst_surface, int scale );
...
void hq2x_32( Uint8 *src_surface, SDL_Surface *dst_surface, int scale );
void hq3x_32( Uint8 *src_surface, SDL_Surface *dst_surface, int scale );
void hq4x_32( Uint8 *src_surface, SDL_Surface *dst_surface, int scale );

void scale2x_32( Uint8 *src_surface, SDL_Surface *dst_surface, int scale );
void scale2x_16( Uint8 *src_surface, SDL_Surface *dst_surface, int scale );
...
void nn_32( Uint8 *src_surface, SDL_Surface *dst_surface, int scale )
{
	Uint8 *src = src_surface, *src_temp,
	      *dst = static_cast<Uint8*>(dst_surface->pixels), *dst_temp;
	int src_pitch = 320,
	    dst_pitch = dst_surface->pitch;
	const int dst_Bpp = 4;         // dst_surface->format->BytesPerPixel
	
	const int height = scr_height, // src_surface->h
	          width = scr_width;   // src_surface->w
